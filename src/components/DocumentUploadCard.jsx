...
const DocumentUploadCard = ({
  ...
  onClick,
  className = "",
  toastMessage = "Click to upload or view document", // Common toast message
}) => {
  ...
  const getCardStyles = () => {
    switch (state) {
      ...
      default:
        return {
          container:
            "border-2 border-dashed border-[#E6E6E6] bg-[#FBFBFB] hover:border-[#079F9F] hover:bg-[#F8FEFE]",
  ...
  const getIcon = () => {
      ...
      return (
        <div className="relative">
          ...
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="absolute top-[18px] left-[21px]"
          >
            <path
    ...
    if (
      ...
      return (
        ...
        >
          <path
            d="M17.3333 29.3337L17.3333 24.0003C17.3333 21.0548 19.7211 18.667 22.6667 18.667L28 18.667M4 24.0003L4 8.00033C4 5.05481 6.38782 2.66699 9.33333 2.66699L22.6667 2.66699C25.6122 2.66699 28 5.05481 28 8.00033V16.4579C28 17.8723 27.4381 19.2289 26.4379 20.2291L18.8954 27.7716C17.8952 28.7718 16.5387 29.3337 15.1242 29.3337H9.33333C6.38781 29.3337 4 26.9458 4 24.0003Z"
            stroke="#333333"
            strokeWidth="2"
            strokeLinejoin="round"
          />
  ...
  return (
    ...
    >
      ...
      {state === "approved" && (
        <div
          className="absolute top-0 right-0 bg-[#079F9F] text-white text-sm font-semibold px-5 py-1 rounded-br-lg rounded-tl-[12px]"
          style={{
      ...
      {state === "rejected" && (
        <div
          className="absolute top-0 right-0 bg-[#FF3E79] text-white text-sm font-semibold px-5 py-1 rounded-br-lg rounded-tl-[12px]"
          style={{
            fontFamily: "Gilroy, -apple-system, Roboto, Helvetica, sans-serif",
          }}
        >
      ...
      {state === "waiting" && (
        <div
          className="absolute top-0 right-0 bg-[#F8A63F] text-white text-sm font-semibold px-5 py-1 rounded-br-lg rounded-tl-[12px]"
          style={{
            fontFamily: "Gilroy, -apple-system, Roboto, Helvetica, sans-serif",
          }}
        >
      ...
      <div className="flex flex-col justify-center flex-1">
        <h3
          className="text-[#434343] font-medium text-lg leading-[27px] mb-1"
          style={{
            fontFamily: "Gilroy, -apple-system, Roboto, Helvetica, sans-serif",
          }}
        >
        ...
        <div className="flex items-center gap-4">
          <p
            className="text-[#999999] text-sm leading-[21px]"
            style={{
              fontFamily:
      ...
      <div className="flex-shrink-0 ml-4 relative">
        <div
          className={`w-14 h-14 rounded-lg border-2 ${styles.iconContainer} flex items-center justify-center`}
        >
          {getIcon()}
        </div>
        {state === "uploaded" && (
      ...
      {/* Hover Toast Message */}
      {isHovered && (
        <div className="absolute bottom-0 left-0 right-0 bg-[#333333] text-white text-xs px-3 py-2 rounded-b-lg transition-all duration-200 ease-in-out">
          <div
