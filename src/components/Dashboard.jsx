...
export default function Dashboard({ userContact, onLogout }) {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-8">
            ...
            <nav className="hidden md:flex space-x-6">
              <a
                href="#"
                className="text-[#079F9F] font-medium border-b-2 border-[#079F9F] pb-1"
              >
                Dashboard
              </a>
              <a
                href="#"
                className="text-[#616060] hover:text-[#282828] transition-colors"
              >
                Manage Leads
              </a>
              <a
          ...
          <Button
            onClick={onLogout}
            variant="outline"
            className="flex items-center space-x-2 border-[#E0E0E0] text-[#616060] hover:text-[#282828]"
          >
