    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">
          View Documents Modal Demo
        </h1>

        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4">
              Default Documents Modal
            </h2>
            <p className="text-gray-600 mb-4">
              Click the button below to open the modal with default document
              data (as shown in the Figma design).
            </p>
            <Button
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mb-4">
              The modal has been integrated into the{" "}
              <strong>LeadDetailsDrawer</strong> component. The &quot;View CIBIL
              Report&quot; button has been updated to &quot;View Documents&quot;
              and now opens this modal.
            </p>
            <p className="text-gray-600">
              You can use this modal component in any part of your application
              by importing it and managing its state.
            </p>
          </div>
        </div>
      </div>
